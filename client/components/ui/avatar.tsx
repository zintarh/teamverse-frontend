 ...
 * Supports images with fallback for when images fail to load.
 */
...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Fallback
    ref={ref}
    className={cn("flex h-full w-full items-center justify-center rounded-full bg-[#131118] text-white", className)}
    {...props}
  />
))
