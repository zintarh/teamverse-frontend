...
export default function IceBreaker() {
    ...
    return (
        <div className="absolute left-0 top-[-3px] w-[130px] h-[137px] md:w-[180px] md:h-[206px]   lg:w-[390px] lg:h-[412px] bg-[linear-gradient(126.3deg,_#FFFFFF_62%,_rgba(85,_82,_255,_0.76)_127.91%)]  flex items-center  justify-between flex-col rounded-[18px] transform rotate-[-3deg] text-[#000000] overflow-hidden animate-rotate-in-left  " >
